/* Evidence in motion.
   The document remains complete with JavaScript disabled. JavaScript only
   adds progressive motion, active-state navigation and screenshot inspection. */
...
(function () {
  ...
  /* Preserve useful mobile labels when the comparison table stacks. */
  ...
  /* One observer, several kinds of evidence. Nothing is hidden before this. */
  ...
  /* Page progress, compact header, section state and case-study state. */
  ...
  function setCurrentSystem(activeSystem) {
    railLinks.forEach(function (link) {
      if (link.dataset.systemTarget === activeSystem) {
